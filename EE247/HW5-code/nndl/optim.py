...
def adam(w, dw, config=None):
  ...
  config['v_hat'] = 1/(1-pow(config['beta1'],config['t']))*config['v']
  config['a_hat'] = 1/(1-pow(config['beta2'],config['t']))*config['a']   
  next_w = w - config['learning_rate']/(np.sqrt(config['a_hat']) + config['epsilon']) * config['v_hat']
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
